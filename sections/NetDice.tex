...
At each link failure scenario, if the property holds, its probability is computed by multiplying the probability of link states.
...
Similarly, the failure of a group of link sharing the same physical resource (shared link risk group or SRLG) is modeled by the failure of the links in the group. 
