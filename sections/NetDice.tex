...
In terms of forwarding graph computation, up and undefined edges are considered traversable whereas down edges are not. 
...
This leads to a dead end in the exploration as no more hot edge can be marked as down.
...
This is done to consider hot edges as up and disregard the undefined cold links, as, regardless of the state of cold links, they do not have impact on rather $\phi$ holds or not.
...
Implementation to retrieve such cold edges are presented considering IGP and BGP protocols.   
...
All the above, although with some inefficiency from the VE algorithm, enables NetDice to verify properties for small imprecision in a reasonable time as tested on synthetic and real ISP network configurations. 
